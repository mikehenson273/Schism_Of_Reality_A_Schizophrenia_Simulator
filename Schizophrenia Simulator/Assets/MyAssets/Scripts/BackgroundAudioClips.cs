...
public class BackgroundAudioClips : MonoBehaviour
{
    ...
    void AudioSettings()
    {
        mySource1_.volume = AppSettings.instance.backgroundAudioVolume;
        mySource2_.volume = AppSettings.instance.backgroundAudioVolume;
